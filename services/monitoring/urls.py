...
from .views import heat_rate_by_ts, co2_reserve_by_ts
...
urlpatterns = [
    ...
    path('co2/<measured_date>/<measured_at_minute>/hr', heat_rate_by_ts, name="heat_rate_by_ts"),
    path('co2/<measured_date>/<measured_at_minute>/reserve', co2_reserve_by_ts, name="co2_reserve_by_ts")
]
